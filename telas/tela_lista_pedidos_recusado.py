...
def criar_tela_lista_pedidos_recusado(window, canvas, usuario_logado):
    ...
    for pedido in pedidos_recusados: # Itera sobre cada pedido recusado para criar um card.
        ...
        card_canvas.tag_bind(tag_card, # Associa um evento de clique ao card.
            "<Button-1>", lambda e, animal=pedido: tools.fade_out(window, canvas, lambda: tela_info_pet_tratamento.criar_tela_info_pet_tratamento(window, canvas, usuario_logado, animal)))

        card_canvas.create_image( # Desenha a imagem placeholder da foto.
            124.0,
            109,
