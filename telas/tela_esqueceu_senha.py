...
def tentar_enviar_codigo(entry_email, window, canvas,):
    ...
    if usuario:
        ...
        tools.custom_messagebox(
            ...
            f"Não encontramos nenhum email cadastrado no P.A.T.A.S. que corresponda ao email inserido."
        )
    ...
    #     resultado_email = usercrud.Usuario.enviar_email(email, str(codigo), mensagem, assunto)
